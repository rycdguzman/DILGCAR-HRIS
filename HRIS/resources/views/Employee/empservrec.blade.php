            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="PdsOfEmp"><i class="fa fa-file-text fa-3x"></i> Personal Data Sheet</a>
                    </li>
                    <li>
                  ...
                  <li  >
                        <a class="active-menu"  href="empservrec.html"><i class="fa fa-square-o fa-3x"></i> Service Record</a>
                    </li>	
                </ul>
